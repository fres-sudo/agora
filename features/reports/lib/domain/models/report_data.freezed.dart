...
/// Number of completed orders in the period.
 ...
 int get cardRevenueCents;/// Hour of day (0–23) with the most completed orders, or null if none.
 int? get peakHour;
...
@override
int get hashCode => Object.hash(runtimeType,totalOrders,totalRevenueCents,totalDiscountCents,itemsSold,averageTicketCents,cashRevenueCents,cardRevenueCents,peakHour);

@override
String toString() {
  return 'ReportSummary(totalOrders: $totalOrders, totalRevenueCents: $totalRevenueCents, totalDiscountCents: $totalDiscountCents, itemsSold: $itemsSold, averageTicketCents: $averageTicketCents, cashRevenueCents: $cashRevenueCents, cardRevenueCents: $cardRevenueCents, peakHour: $peakHour)';
}
...
@useResult
$Res call({
 int totalOrders, int totalRevenueCents, int totalDiscountCents, int itemsSold, int averageTicketCents, int cashRevenueCents, int cardRevenueCents, int? peakHour
});
...
/// Create a copy of ReportSummary
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? totalOrders = null,Object? totalRevenueCents = null,Object? totalDiscountCents = null,Object? itemsSold = null,Object? averageTicketCents = null,Object? cashRevenueCents = null,Object? cardRevenueCents = null,Object? peakHour = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int totalOrders,  int totalRevenueCents,  int totalDiscountCents,  int itemsSold,  int averageTicketCents,  int cashRevenueCents,  int cardRevenueCents,  int? peakHour)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReportSummary() when $default != null:
return $default(_that.totalOrders,_that.totalRevenueCents,_that.totalDiscountCents,_that.itemsSold,_that.averageTicketCents,_that.cashRevenueCents,_that.cardRevenueCents,_that.peakHour);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int totalOrders,  int totalRevenueCents,  int totalDiscountCents,  int itemsSold,  int averageTicketCents,  int cashRevenueCents,  int cardRevenueCents,  int? peakHour)  $default,) {final _that = this;
switch (_that) {
case _ReportSummary():
return $default(_that.totalOrders,_that.totalRevenueCents,_that.totalDiscountCents,_that.itemsSold,_that.averageTicketCents,_that.cashRevenueCents,_that.cardRevenueCents,_that.peakHour);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int totalOrders,  int totalRevenueCents,  int totalDiscountCents,  int itemsSold,  int averageTicketCents,  int cashRevenueCents,  int cardRevenueCents,  int? peakHour)?  $default,) {final _that = this;
switch (_that) {
case _ReportSummary() when $default != null:
return $default(_that.totalOrders,_that.totalRevenueCents,_that.totalDiscountCents,_that.itemsSold,_that.averageTicketCents,_that.cashRevenueCents,_that.cardRevenueCents,_that.peakHour);case _:
  return null;
...
class _ReportSummary extends ReportSummary {
  const _ReportSummary({this.totalOrders = 0, this.totalRevenueCents = 0, this.totalDiscountCents = 0, this.itemsSold = 0, this.averageTicketCents = 0, this.cashRevenueCents = 0, this.cardRevenueCents = 0, this.peakHour}): super._();
...
/// Create a copy of ReportSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? totalOrders = null,Object? totalRevenueCents = null,Object? totalDiscountCents = null,Object? itemsSold = null,Object? averageTicketCents = null,Object? cashRevenueCents = null,Object? cardRevenueCents = null,Object? peakHour = freezed,}) {
