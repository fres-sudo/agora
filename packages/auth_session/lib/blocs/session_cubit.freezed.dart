...
class _Initial with DiagnosticableTreeMixin implements SessionState {
  const _Initial();
...
class _Loading with DiagnosticableTreeMixin implements SessionState {
  const _Loading();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'SessionState.loading'))
    ;
}
...
class Authenticated with DiagnosticableTreeMixin implements SessionState {
...
class Unauthenticated with DiagnosticableTreeMixin implements SessionState {
...
class SessionError with DiagnosticableTreeMixin implements SessionState {
