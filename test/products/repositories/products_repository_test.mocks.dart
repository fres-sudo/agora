...
class _Fake$ModifiersTableTable_18 extends _i1.SmartFake
    implements _i2.$ModifiersTableTable {
  _Fake$ModifiersTableTable_18(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ModifierOptionsTableTable_19 extends _i1.SmartFake
    implements _i2.$ModifierOptionsTableTable {
  _Fake$ModifierOptionsTableTable_19(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ProductModifierLinksTableTable_20 extends _i1.SmartFake
    implements _i2.$ProductModifierLinksTableTable {
  _Fake$ProductModifierLinksTableTable_20(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockProductsDao extends _i1.Mock implements _i6.ProductsDao {
  ...
  @override
  _i5.Future<bool> softDeleteProduct(int? id) => (super.noSuchMethod(
        Invocation.method(
          #softDeleteProduct,
          [id],
        ),
  ...
  @override
  _i5.Future<bool> restoreProduct(int? id) => (super.noSuchMethod(
        Invocation.method(
          #restoreProduct,
          [id],
        ),
  ...
  @override
  _i5.Future<int> hardDeleteProduct(int? id) => (super.noSuchMethod(
        Invocation.method(
          #hardDeleteProduct,
          [id],
        ),
...
class MockModifiersDao extends _i1.Mock implements _i9.ModifiersDao {
  ...
  _i2.$ModifiersTableTable get modifiersTable => (super.noSuchMethod(
        ...
        returnValue: _Fake$ModifiersTableTable_18(
          this,
          Invocation.getter(#modifiersTable),
        ),
  ...
  _i2.$ModifierOptionsTableTable get modifierOptionsTable =>
      (super.noSuchMethod(
        ...
        returnValue: _Fake$ModifierOptionsTableTable_19(
          this,
          Invocation.getter(#modifierOptionsTable),
        ),
  ...
  _i2.$ProductModifierLinksTableTable get productModifierLinksTable =>
      (super.noSuchMethod(
        ...
        returnValue: _Fake$ProductModifierLinksTableTable_20(
          this,
          Invocation.getter(#productModifierLinksTable),
        ),
  ...
  @override
  _i5.Future<int> getModifiersCount() => (super.noSuchMethod(
        Invocation.method(
          #getModifiersCount,
          [],
        ),
  ...
  @override
  _i5.Future<bool> softDeleteModifier(int? id) => (super.noSuchMethod(
        Invocation.method(
          #softDeleteModifier,
          [id],
        ),
  ...
  @override
  _i5.Future<bool> restoreModifier(int? id) => (super.noSuchMethod(
        Invocation.method(
          #restoreModifier,
          [id],
        ),
  ...
  @override
  _i5.Future<int> hardDeleteModifier(int? id) => (super.noSuchMethod(
        Invocation.method(
          #hardDeleteModifier,
          [id],
        ),
  ...
  @override
  _i5.Future<bool> softDeleteModifierOption(int? id) => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<int> hardDeleteModifierOption(int? id) => (super.noSuchMethod(
        Invocation.method(
          #hardDeleteModifierOption,
          [id],
        ),
        returnValue: _i5.Future<int>.value(0),
      ) as _i5.Future<int>);
  ...
  _i5.Future<List<_i2.ModifierEntity>> getModifiersByProductId(
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i5.Future<List<_i2.ModifierEntity>>.value(<_i2.ModifierEntity>[]),
