...
class _Fake$StockMovementsTableTable_17 extends _i1.SmartFake
  ...
  _Fake$StockMovementsTableTable_17(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockStockMovementsDao extends _i1.Mock implements _i8.StockMovementsDao {
  ...
  @override
  _i2.$StockMovementsTableTable get stockMovementsTable => (super.noSuchMethod(
  ...
  @override
  _i5.Future<bool> softDeleteMovement(int? id) => (super.noSuchMethod(
        Invocation.method(
          #softDeleteMovement,
          [id],
        ),
  ...
  @override
  _i5.Future<int> hardDeleteMovement(int? id) => (super.noSuchMethod(
        Invocation.method(
          #hardDeleteMovement,
          [id],
        ),
  ...
  _i5.Future<int> hardDeleteMovementsByProductId(int? productId) =>
      (super.noSuchMethod(
        Invocation.method(
          #hardDeleteMovementsByProductId,
          [productId],
        ),
        returnValue: _i5.Future<int>.value(0),
      ) as _i5.Future<int>);
