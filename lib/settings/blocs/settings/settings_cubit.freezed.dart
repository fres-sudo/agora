...
extension SettingsStatePatterns on SettingsState {
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(Map<String, String> settings)? loaded,
    TResult Function(Map<String, String> settings)? saving,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Map<String, String> settings) loaded,
    required TResult Function(Map<String, String> settings) saving,
...
class SettingsLoaded extends SettingsState {
  const SettingsLoaded({required final Map<String, String> settings})
      : _settings = settings,
        super._();
...
abstract mixin class $SettingsLoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({Map<String, String> settings});
}
...
class _Saving extends SettingsState {
  const _Saving({required final Map<String, String> settings})
      : _settings = settings,
        super._();
