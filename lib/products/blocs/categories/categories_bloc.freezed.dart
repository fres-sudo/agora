  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case _Started() when started != null:
        return started();
      case _Created() when created != null:
        return created(_that.category);
      case _Updated() when updated != null:
        return updated(_that.category);
      case _Deleted() when deleted != null:
...
extension CategoriesStatePatterns on CategoriesState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case CategoriesLoaded() when loaded != null:
        return loaded(_that);
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(String message, CategoriesLoaded? previousState)? error,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, CategoriesLoaded? previousState)
        error,
  }) {
    final _that = this;
    switch (_that) {
...
class CategoriesLoaded extends CategoriesState {
  const CategoriesLoaded({required final List<Category> categories})
...
abstract mixin class _$ErrorCopyWith<$Res>
  ...
  @useResult
  $Res call({String message, CategoriesLoaded? previousState});
}
