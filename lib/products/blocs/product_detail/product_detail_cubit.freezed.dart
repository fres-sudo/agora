...
extension ProductDetailStatePatterns on ProductDetailState {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case ProductDetailLoaded() when loaded != null:
        return loaded(_that);
      case _Creating() when creating != null:
        return creating(_that);
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(Product product, List<ModifierGroup> modifiers)? loaded,
    TResult Function()? creating,
    TResult Function(Product product)? saving,
    TResult Function(Product product)? saved,
    TResult Function(Product product)? deleting,
    TResult Function()? deleted,
    TResult Function(String message, Product? product)? error,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      ...
      case _Loading() when loading != null:
        return loading();
      case ProductDetailLoaded() when loaded != null:
        return loaded(_that.product, _that.modifiers);
      case _Creating() when creating != null:
        return creating();
      case _Saving() when saving != null:
        return saving(_that.product);
      case _Saved() when saved != null:
        return saved(_that.product);
      case _Deleting() when deleting != null:
        return deleting(_that.product);
      case _Deleted() when deleted != null:
        return deleted();
      case _Error() when error != null:
        return error(_that.message, _that.product);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Product product, List<ModifierGroup> modifiers)
        loaded,
    required TResult Function() creating,
    required TResult Function(Product product) saving,
    required TResult Function(Product product) saved,
    required TResult Function(Product product) deleting,
    required TResult Function() deleted,
    required TResult Function(String message, Product? product) error,
  }) {
    final _that = this;
    switch (_that) {
      case _Initial():
...
class ProductDetailLoaded extends ProductDetailState {
  const ProductDetailLoaded(
      {required this.product, final List<ModifierGroup> modifiers = const []})
...
abstract mixin class $ProductDetailLoadedCopyWith<$Res>
  ...
  @useResult
  $Res call({Product product, List<ModifierGroup> modifiers});
}
...
class _Error extends ProductDetailState {
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, message, const DeepCollectionEquality().hash(product));
...
abstract mixin class _$ErrorCopyWith<$Res>
  ...
  @useResult
  $Res call({String message, Product? product});
}
