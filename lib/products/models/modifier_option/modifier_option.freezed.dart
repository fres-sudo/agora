...
mixin _$ModifierOption {
  ...
  $ModifierOptionCopyWith<ModifierOption> get copyWith =>
      _$ModifierOptionCopyWithImpl<ModifierOption>(
          this as ModifierOption, _$identity);
...
abstract mixin class $ModifierOptionCopyWith<$Res> {
  factory $ModifierOptionCopyWith(
          ModifierOption value, $Res Function(ModifierOption) _then) =
      _$ModifierOptionCopyWithImpl;
  @useResult
  $Res call({int id, String name, int priceChangeCents});
}
...
extension ModifierOptionPatterns on ModifierOption {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModifierOption value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String name, int priceChangeCents)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ModifierOption() when $default != null:
        return $default(_that.id, _that.name, _that.priceChangeCents);
      case _:
        return orElse();
    }
  }
...
class _ModifierOption extends ModifierOption {
  const _ModifierOption(
      {required this.id, required this.name, required this.priceChangeCents})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ModifierOptionCopyWith<_ModifierOption> get copyWith =>
      __$ModifierOptionCopyWithImpl<_ModifierOption>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ModifierOption &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.priceChangeCents, priceChangeCents) ||
                other.priceChangeCents == priceChangeCents));
...
/// @nodoc
abstract mixin class _$ModifierOptionCopyWith<$Res>
    implements $ModifierOptionCopyWith<$Res> {
  factory _$ModifierOptionCopyWith(
          _ModifierOption value, $Res Function(_ModifierOption) _then) =
      __$ModifierOptionCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String name, int priceChangeCents});
}
