...
mixin _$ModifierGroup {
  int get id;
  String get name; // e.g., "Milk Option"
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, isMultiSelect,
...
extension ModifierGroupPatterns on ModifierGroup {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String name, bool isMultiSelect,
    ...
    switch (_that) {
      case _ModifierGroup() when $default != null:
        return $default(
            _that.id, _that.name, _that.isMultiSelect, _that.options);
      case _:
        return orElse();
    }
  }
