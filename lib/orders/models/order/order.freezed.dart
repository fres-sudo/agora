  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.grandTotalCents, grandTotalCents) ||
                other.grandTotalCents == grandTotalCents));
  }
    ...
    return _then(_self.copyWith(
      ...
      discountCents: null == discountCents
          ...
          : discountCents // ignore: cast_nullable_to_non_nullable
              as int,
      grandTotalCents: null == grandTotalCents
          ? _self.grandTotalCents
          : grandTotalCents // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
class _Order extends Order {
  const _Order(
      ...
      required final List<OrderLineItem> items,
      required this.note,
