...
mixin _$SelectedModifiers {
  ...
  $SelectedModifiersCopyWith<SelectedModifiers> get copyWith =>
      _$SelectedModifiersCopyWithImpl<SelectedModifiers>(
          this as SelectedModifiers, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SelectedModifiers &&
            (identical(other.groupName, groupName) ||
                other.groupName == groupName) &&
            (identical(other.optionName, optionName) ||
                other.optionName == optionName) &&
            (identical(other.priceChangeCents, priceChangeCents) ||
                other.priceChangeCents == priceChangeCents));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, groupName, optionName, priceChangeCents);
...
abstract mixin class $SelectedModifiersCopyWith<$Res> {
  factory $SelectedModifiersCopyWith(
          SelectedModifiers value, $Res Function(SelectedModifiers) _then) =
      _$SelectedModifiersCopyWithImpl;
  @useResult
  $Res call({String groupName, String optionName, int priceChangeCents});
}
    ...
    return _then(_self.copyWith(
      ...
      optionName: null == optionName
          ...
          : optionName // ignore: cast_nullable_to_non_nullable
              as String,
      priceChangeCents: null == priceChangeCents
          ? _self.priceChangeCents
          : priceChangeCents // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
extension SelectedModifiersPatterns on SelectedModifiers {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SelectedModifiers value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String groupName, String optionName, int priceChangeCents)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SelectedModifiers() when $default != null:
        return $default(
            _that.groupName, _that.optionName, _that.priceChangeCents);
      case _:
        return orElse();
    }
  }
...
// e.g., "Large"
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SelectedModifiersCopyWith<_SelectedModifiers> get copyWith =>
      __$SelectedModifiersCopyWithImpl<_SelectedModifiers>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SelectedModifiers &&
            (identical(other.groupName, groupName) ||
                other.groupName == groupName) &&
            (identical(other.optionName, optionName) ||
                other.optionName == optionName) &&
...
/// @nodoc
abstract mixin class _$SelectedModifiersCopyWith<$Res>
    implements $SelectedModifiersCopyWith<$Res> {
  factory _$SelectedModifiersCopyWith(
          _SelectedModifiers value, $Res Function(_SelectedModifiers) _then) =
      __$SelectedModifiersCopyWithImpl;
  @override
  @useResult
  $Res call({String groupName, String optionName, int priceChangeCents});
}
