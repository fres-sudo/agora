...
mixin _$OrderLineItem {
  ...
  int get quantity;
  int get unitPriceCents; // Snapshot price
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.selectedModifiers, selectedModifiers));
  }

  @override
  int get hashCode => Object.hash(runtimeType, productId, productName, quantity,
      unitPriceCents, const DeepCollectionEquality().hash(selectedModifiers));
...
abstract mixin class $OrderLineItemCopyWith<$Res> {
  ...
  $Res call(
      ...
      int quantity,
      int unitPriceCents,
      List<SelectedModifiers> selectedModifiers});
}
...
extension OrderLineItemPatterns on OrderLineItem {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int? productId, String productName, int quantity,
            int unitPriceCents, List<SelectedModifiers> selectedModifiers)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _OrderLineItem() when $default != null:
        return $default(_that.productId, _that.productName, _that.quantity,
            _that.unitPriceCents, _that.selectedModifiers);
      case _:
        return orElse();
    }
  }
...
class _OrderLineItem extends OrderLineItem {
  const _OrderLineItem(
      ...
      required final List<SelectedModifiers> selectedModifiers})
...
// Snapshot price
  ...
  @override
  int get hashCode => Object.hash(runtimeType, productId, productName, quantity,
      unitPriceCents, const DeepCollectionEquality().hash(_selectedModifiers));
